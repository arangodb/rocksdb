...
void ColumnFamilyData::SetCurrent(Version* current_version) {
  ROCKS_LOG_INFO(ioptions_.info_log,
                 "[%s] Setting current version to %ld; storage %p",
                 name_.c_str(), current_version->GetVersionNumber(),
                 (void*)current_version->storage_info());
...
void ColumnFamilyData::InstallSuperVersion(
  ...
  ROCKS_LOG_INFO(ioptions_.info_log, "[%s] Finished InstallSuperVersion",
                 GetName().c_str());
}
